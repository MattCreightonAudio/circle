...
ax.margins(0.1) # Add some padding
...
slider_Ar = Slider(ax=ax_Ar, label='$A_r$', valmin=0.0, valmax=5.0, valinit=initial_Ar)
slider_Al = Slider(ax=ax_Al, label='$A_l$', valmin=0.0, valmax=5.0, valinit=initial_Al)

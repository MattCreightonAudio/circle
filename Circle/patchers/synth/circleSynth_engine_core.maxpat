        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 1394.736828804016, 315.1315759420395, 100.0, 22.0 ],
                    "text": "mc.*~"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 475.0, 776.0, 100.0, 22.0 ],
                    "text": "!=~ 0."
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 463.0, 730.0, 84.0, 22.0 ],
                    "text": "r~ #0_pitch"
                }
            },
            {

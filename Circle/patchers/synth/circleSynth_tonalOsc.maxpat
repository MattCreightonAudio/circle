        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 659.0, 256.0, 150.0, 89.0 ],
                    "text": "sizes are in milliseconds - 10ms is 440 harmonics so you have functionally infinite space in these buffers\n"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 149.0, 42.0, 40.29411745071411, 20.0 ],
                    "text": "PD"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 159.0, 81.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 369.85293412208557, 56.00000047683716, 80.0, 20.0 ],
                    "text": "phase mod"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 390.4411690235138, 81.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
